					...
					<div class="classy-menu">
						...
						<div class="classynav">
							<ul id="nav">
								...
								<c:if test="${name!=null }">
									<li><a>『 Welcome!&nbsp;&nbsp;&nbsp;${sessionScope.name }'s
											』</a></li>
			...
			<div class="row">
				...
				<div class="col-12 col-sm-6 col-lg-4">
					<div class="about-us-thumbnail mb-50">
						<span class="line"></span> <img src="./img/bg-img/gogh.PNG" alt=""
							onclick="location.href='https://www.vangoghmuseum.nl/en'">
				...
				<div class="col-12 col-lg-4">
					<div class="about-us-content mb-50">
						...
						<p>1853.3.30 ~ 1890.7.29</p>
						<p>네덜란드 쥔데르트</p>
						<p>네덜란드 출신으로 주로 남프랑스에서 작품활동을 하였다. 고갱과 친밀했으며 자신의 귀를 자른 사건으로
							유명하다. 작품에 《빈센트의 방》,《별이 빛나는 밤》,《밤의 카페》등이 있다.</p>
					</div>
				</div>
			</div>
		</div>
