        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <form action="memberJoin" method="post">
              <input type="text" name="ID" class="form-control" placeholder="ID (10pt)">
              <input type="password" name="PW" class="form-control" placeholder="PASSWORD (15pt)">
              <input type="text" name="NAMES" class="form-control" placeholder="NICK NAME (10pt)">
    ...
    <div class="welcome-slides owl-carousel">
     ...
     <!-- Single Welcome Slide -->
      <div class="single-welcome-slide">
        ...
        <div class="bg-curve" style="background-image: url(./img/core-img/curve.png);"></div>
        <!-- Main Background Image -->
        <div class="main-bg-img bg-img"  style="background-image: url(./img/bg-img/dega.jpg);"></div>
        <!-- Welcome Text -->
        <div class="container h-100">
          <div class="row h-100 align-items-center">
            <div class="col-12">
