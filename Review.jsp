        ...
        <div class="col-12 col-md-10">
          <div class="slider slider-for">
            ...
            <div class="client-feedback-text text-center">
              ...
              <c:if test="${name==rList.id }">
              <div class="comment-meta">
                <a href="PassConfirm.jsp?num=${rList.num}&title=${rList.title}&id=${rList.id}&content=${rList.content}">「 수정 」</a>
                <a href="ReviewDelete.jsp?num=${rList.num}">「 삭제 」</a>
             </div>
             </c:if>
            </div>
          </div>
