        ...
        <div class="col-12 col-lg-6 col-xl-5">
          <div class="casting-form mona-contact-form mb-80">
            <div class="contact-heading">
              ...
              <p>Thank you for your review, The reviews you left behind are used for development on the Orsay Museum page.</p>
            </div>
            ...
            <form action="ProcessReview" method="post" name="write">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" name="title" value="<%=title%>">
              </div>
              <div class="form-group">
                <label for="resume">Content:</label>
                <textarea class="form-control" name="content" rows="8" cols="80"><%=content%></textarea>
              </div>
